...
export function getConfiguration(): Configuration {
  ...
  const notifRaw = config.get('notificationsLevel', 'silent') as unknown as string
  ...
  return Object.freeze({
    ...
    regexRealtimePreviewEnabled: Boolean(config.get('regex.realtimePreviewEnabled', true)),
    regexRedosDetectionEnabled: Boolean(config.get('regex.redosDetectionEnabled', true)),
